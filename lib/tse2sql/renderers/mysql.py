...
CREATE TABLE IF NOT EXISTS `tse2sql`.`district` (
  `id_district` MEDIUMINT(4) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tse2sql`.`voter` (
  ...
  `code` INT NULL,
  `district_id_district` MEDIUMINT(4) UNSIGNED NOT NULL,
...
BEGIN
    ...
    CREATE TABLE `tse2sql`.`denormalized` (
        ...
        INDEX `id_canton_idx` (`id_canton` ASC),
        INDEX `id_district_idx` (`id_district` ASC),
        FULLTEXT INDEX `full_name_idx` (`full_name` ASC)
    )
    ENGINE = InnoDB;
